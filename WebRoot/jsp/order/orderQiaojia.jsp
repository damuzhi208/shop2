...
<body>
	<div class="easyui-layout" fit="true" style="border:none;">
		<div id="toolbar" style="height: 44px;padding:7px 2px">
			<span class="easyui-addbtn" onclick="addBtnQj('${qj.type }','${qj.mType }');">新增</span>
		</div>  		
		<div data-options="region:'center',border:false" style=" border:none">
			<table id="datagrid" class="easyui-datagrid"  fit="true" 
				data-options="
						...
						url:'<%=basePath %>order/qiaojiaData?orderId=${qj.orderId }&type=${qj.type }&mType=${qj.mType }'"
				>
				<thead data-options="frozen:true">
		    		<tr>
		    			<th data-options="field:'1',align:'left',width:360,formatter:guigeFormatter">桥架规格</th>
	...
	<script type="text/javascript" src="<%=basePath %>jsp/order/orderQiaojia.js"></script>
  </body>
</html>
